	...
	<div class="container" style="width:99%;">
		<div class="row" style="margin-top: 55px; padding-bottom: 10px; padding-top: 15px;">
            ...
            <div class="panel panel-default">
                ...
                echo "</tr>";
                echo "<tr>";
                echo "<th style='border-left:1px solid #000000;'>PID</th><th>NAME</th><th>AGE</th><th>GENDER</th><th>CIVIL STATUS</th><th>DATE OF VISIT</th>";
                ...
                foreach ($rows as $row) {
                    ...
                    echo "<td class='tdc'>" . strtoupper($row->CreateDate) . "</td>";
